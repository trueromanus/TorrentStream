# TorrentStream
Simple cross platform web server for streaming torrent files in video players (like VLC, mpv, MPC-HC and so on). Application have experimental optional desktop UI. Can be used as a console application as well as a dynamic library.
